...
export { WithTrace, WithMetrics, WithTelemetry, OutboxOperation } from './decorators/telemetry.decorator';
export type { TraceConfig, MetricsConfig } from './decorators/telemetry.decorator';
